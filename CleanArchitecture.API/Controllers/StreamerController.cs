...
namespace CleanArchitecture.API.Controllers
{
    ...
    public class StreamerController : ControllerBase
    {
        ...
        [ProducesResponseType(StatusCodes.Status204NoContent)]//por si no hay nada
        [ProducesResponseType(StatusCodes.Status404NotFound)]//por si no encuentra nada
        [ProducesDefaultResponseType]//por defecto
